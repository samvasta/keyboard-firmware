...
#define ENT HID_KEY_ENTER
#define ESC HID_KEY_ESCAPE
#define BSPC HID_KEY_BACKSPACE
#define TAB HID_KEY_TAB
#define SPC HID_KEY_SPACE
...
#define INS HID_KEY_INSERT
#define HOME HID_KEY_HOME
#define PGUP HID_KEY_PAGE_UP
#define DEL HID_KEY_DELETE
#define END HID_KEY_END
#define PGDN HID_KEY_PAGE_DOWN
#define RIGHT HID_KEY_ARROW_RIGHT
#define LEFT HID_KEY_ARROW_LEFT
#define DOWN HID_KEY_ARROW_DOWN
#define UP HID_KEY_ARROW_UP

#define LCTL HID_KEY_CONTROL_LEFT
#define LSFT HID_KEY_SHIFT_LEFT
#define LALT HID_KEY_ALT_LEFT
#define LGUI HID_KEY_GUI_LEFT
#define RCTL HID_KEY_CONTROL_RIGHT
#define RSFT HID_KEY_SHIFT_RIGHT
#define RALT HID_KEY_ALT_RIGHT
#define RGUI HID_KEY_GUI_RIGHT
...
// Brightness
#define BRI_U HID_USAGE_CONSUMER_BRIGHTNESS_INCREMENT | KEY_CODE_CONSUMER_CONTROL_START
#define BRI_D HID_USAGE_CONSUMER_BRIGHTNESS_DECREMENT | KEY_CODE_CONSUMER_CONTROL_START

// Media
#define M_PP HID_USAGE_CONSUMER_PLAY_PAUSE | KEY_CODE_CONSUMER_CONTROL_START
#define M_NXT HID_USAGE_CONSUMER_SCAN_NEXT | KEY_CODE_CONSUMER_CONTROL_START
#define M_PRV HID_USAGE_CONSUMER_SCAN_PREVIOUS | KEY_CODE_CONSUMER_CONTROL_START
#define M_STP HID_USAGE_CONSUMER_STOP | KEY_CODE_CONSUMER_CONTROL_START
#define MUTE HID_USAGE_CONSUMER_MUTE | KEY_CODE_CONSUMER_CONTROL_START
#define VOLU HID_USAGE_CONSUMER_VOLUME_INCREMENT | KEY_CODE_CONSUMER_CONTROL_START
#define VOLD HID_USAGE_CONSUMER_VOLUME_DECREMENT | KEY_CODE_CONSUMER_CONTROL_START
...
#define SET_ALPHA(layer) ((layer & 0x00ff) | KEY_CODE_ALPHA_RANGE_START)
#define GOTO_QWER SET_ALPHA(ALPHA_QWERTY)
#define GOTO_QGML SET_ALPHA(ALPHA_QGMLWY)
#define GOTO_NORD SET_ALPHA(ALPHA_NORD)
#define GOTO_NORDM SET_ALPHA(ALPHA_NORD_MIRROR)

#define KEY_CODE_SHIFTED_CHAR 0x6900

#define NUM_ALPHA_LAYERS _num_alpha_layers & 0xff

#define CUSTOM_KEY_CODE_RANGE_START 0x7000

static bool is_hid_modifier(keycode_t kc)
{
  return kc >= LCTL && kc <= RGUI;
}

static bool is_hid_code(keycode_t kc)
{
  return kc < KEY_CODE_LAYER_RANGE_START && !is_hid_modifier(kc);
}
...
enum custom_keycodes
{
  ...
  CTRL_CMD, // Control on Windows/Linux, Command on OSX
  CTRL_ALT, // Control on Windows/Linux, Alt on OSX
  ALT_CMD, // Alt on Windows/Linux, Command on OSX
  SHIFT_ALT, // Shift on Windows/Linux, Alt on OSX

  OSX,       // Set os mode to OSX
  LINUX,     // Set os mode to Linux
  OS_TOG, // Toggle between os modes
};
...
#define LBRK S(KEY_BRK_L)
#define RBRK S(KEY_BRK_R)
#define LBRC KEY_BRK_L
#define RBRC KEY_BRK_R
#define LPAR S(KEY_9)
#define RPAR S(KEY_0)
...
#define DLR S(KEY_4)
#define PERC S(KEY_5)
#define CARET S(KEY_6)
#define AMPR S(KEY_7)
#define ASTER S(KEY_8)

#define DASH KEY_MIN
#define UNDERS S(KEY_MIN)

#define DOT KEY_DOT
#define COMMA KEY_COMMA

#define GRV KEY_GRV
#define TILD S(KEY_GRV)

#define APOS KEY_APOS
#define DQUOT S(KEY_APOS)

#define PIPE S(KEY_BSLASH)
#define BSLSH KEY_BSLASH

#define CLN S(KEY_SEMI)
#define SCLN KEY_SEMI

#define QUES S(KEY_SLSH)
#define SLSH KEY_SLSH

#define LT S(KEY_COMMA)
#define GT S(KEY_DOT)

#define EQ KEY_EQ
#define PLUS S(KEY_EQ)